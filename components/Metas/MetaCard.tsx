  ...
  return (
    <>
      ...
      <div 
        ...
        className="w-full min-w-[280px] max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300 cursor-pointer h-64"
      >
        <div className="p-4 h-full flex flex-col">
          <div className="flex justify-between items-start gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className={`text-xs px-2 py-1 rounded-full ${getEstadoStyles(meta.Estado ?? "sin estado")} whitespace-nowrap`}>
                {meta.Estado}
              </span>
              {onEdit && (meta.Estado != "Completada") && (
                <button 
                  onClick={(e) => {
                    e.stopPropagation();
                    onEdit(meta);
          ...
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            ...
            <div className="truncate">
              ...
              <span className="ml-1 text-gray-600 truncate">{formatDate(meta.Fecha_Inicio ?? null)}</span>
            </div>
            <div className="truncate">
            ...
            <div className="truncate">
              <span className="font-medium text-gray-700">Registrada:</span>
          ...
          {/* Mostrar revisores en la tarjeta principal */}
          {meta.Revisores && meta.Revisores.length > 0 && (
            <div className="mt-2 pt-2 border-t border-gray-100">
              <h4 className="text-xs font-medium text-gray-700">Revisores:</h4>
              <p className="text-xs text-gray-600 mt-1 line-clamp-1">
                {meta.Revisores.map(revisor => revisor.Nombre).join(', ')}
              </p>
            </div>
          )}
          ...
          {meta.Self_Reflection && (
            <div className="mt-2 pt-2 border-t border-gray-100">
              <div className="flex justify-between items-center">
                <h4 className="text-sm font-medium text-gray-700">Auto-reflexión:</h4>
              </div>
