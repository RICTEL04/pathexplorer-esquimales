...
test.describe('Browser Suite', () => {
  test.describe('HU_06', () => {
    test('ID: TC-HU06.CA3 Proyectos recomendados basados en habilidades', async ({ page, browserName }, testInfo) => {
      // Configurar metadatos para Qase
      configureQaseTest({
        hu: 'HU_06',
        title: 'ID: TC-HU06.CA3 Proyectos recomendados basados en habilidades',
        description: `**Descripción**: Los proyectos recomendados para el empleado estan basados en las habilidades.
...
**Navegador**: ${browserName}`,
      ...
      try {
        ...
        await test.step('Verificar habilidades', async () => {
          ...
          await attachScreenshot(testInfo, 'Verificó las habilidades', page);
        });
        ...
        await test.step('Verificar todos los proyectos' , async () => {
            ...
            await attachScreenshot(testInfo, 'Verificó las habilidades de un proyecto disponible', page);
        })
